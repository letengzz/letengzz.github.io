...
![image-20241022094247331](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220942779.png)
...
- 图形验证码功能
  ...
  ![image-20241022094332414](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220943718.png)

- 表格无限滚动功能：

  ![image-20241022094547155](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220945895.png)

- 部分页面展示：

  控制台：

  ![image-20241022094624237](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220946768.png)

  数据列表：

  ![image-20241022095008430](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220950298.png)

  结果页：

  ![image-20241022094931871](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220949307.png)

  用户管理：

  ![image-20241022094847450](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220948308.png)

  菜单管理：

  ![image-20241022094827496](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220948326.png)

  富文本编辑器：

  ![image-20241022094751222](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202410220947121.png)
