...
![6.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/DotNet/202412101718753.png)
...
## C#程序类结构
![8.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/DotNet/202412101724079.png)
**_行号_** ：左侧数字
...
![装箱.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/DotNet/202412101723083.png)
拆箱：
    1.获取托管堆中属于值类型那部分字段的地址
    2.将引用对象中的值拷贝到位于栈上的值类型实例中。
![拆箱.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/DotNet/202412101724137.png)
