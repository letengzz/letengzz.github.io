...
## Winform项目窗口
Winform项目窗体设计窗口组成：
![6.png](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202411052355247.png)
**菜单、工具栏**
**解决方案资源管理器**：一个或多个项目容器
**属性面板**：控件的属性设置面板
...
## C#程序类结构
![8.png](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202411052355206.png)
**_行号_** ：左侧数字
...
![装箱.png](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202411052356586.png)
拆箱：
    1.获取托管堆中属于值类型那部分字段的地址
    2.将引用对象中的值拷贝到位于栈上的值类型实例中。
![拆箱.png](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202411052356454.png)
