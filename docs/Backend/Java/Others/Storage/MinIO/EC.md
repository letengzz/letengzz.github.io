...
![image-20240512212535303](https://cdn.jsdelivr.net/gh/LetengZzz/img/java/others/202412092359218.png)

minio 集群部署被强制性安装在独占的磁盘分区，不能在 root 根盘符下建立目录，如在 /opt/data1 等等建目录文件夹代替，会抛出错误提示。因此可以在系统已挂载的磁盘下建 data 目录。

![image-20240512212423199](https://cdn.jsdelivr.net/gh/LetengZzz/img/java/others/202412092359920.png)
...
4. 启动纠删码模式：
   ...
   ![image-20240512212328430](https://cdn.jsdelivr.net/gh/LetengZzz/img/java/others/202412092359204.png)
