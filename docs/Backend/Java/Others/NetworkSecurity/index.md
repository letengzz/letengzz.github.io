...
![image-20230701174518205](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092350585.png)
...
![image-20230701175101126](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092350474.png)
...
![image-20230701175235964](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092350220.png)
...
为了测试网站安全性，使用基于SpringBoot 框架搭建一个采用之前的验证方式的简易网站。
...
![image-20230825140338162](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351021.png)
...
![image-20230825140857385](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351940.png)

### CSRF跨站请求伪造攻击

我们时常会在QQ上收到别人发送的钓鱼网站链接，只要你在上面登陆了你的QQ账号，那么不出意外，你的号已经在别人手中了。实际上这一类网站都属于恶意网站，专门用于盗取他人信息，执行非法操作，甚至获取他人账户中的财产，非法转账等。

![image-20230701181244150](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351170.png)
...
![image-20230825141425804](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351660.png)

接着假装自己上当，进入到钓鱼网站：

![image-20230825141508073](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351065.png)

现在我们毫不知情，如果是正常人思维的话，就会直接点击下载全套视频，恭喜，此时后台已经转账成功了，留下一脸懵逼的你：

![image-20230825141535583](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351623.png)
...
![a3421f74c3cee6b67d214809adb743a5](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351606.png)
...
![image-20230825142023020](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351200.png)
...
![image-20230825142343165](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092351020.png)

可以看到此时用户的浏览器JSESSIONID值为刚刚恶意网站伪造的值，现在来进行登录操作：

![image-20230825142425456](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092352593.png)
...
![image-20230702002624508](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092352447.png)
...
![image-20230702003831742](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092352387.png)
...
![image-20230702004827194](https://fastly.jsdelivr.net/gh/LetengZzz/img/java/others/202412092353674.png)
