...
1. 生产太快了：
   ...
   **解决办法**： 
   ...
   - 动态扩容队列数量，从而增加消费者数量 (最好不要动)
     ...
     ![image-20240329173952412](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/java/mq/202412101557397.png)
...
![image-20240329173815741](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/java/mq/202412101557652.png)
