...
![filterchain](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202402241522175.png)
...
![delegatingfilterproxy](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202402241522462.png)
...
![filterchainproxy](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202402241522345.png)
...
![securityfilterchain](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202402241522396.png)
...
![multi-securityfilterchain-17016804731631](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202402241522529.png)
...
![image-20231204230216259](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202402241522159.png)

### SecurityProperties

默认情况下Spring Security将初始的用户名和密码存在了SecurityProperties类中。这个类中有一个静态内部类User，配置了默认的用户名（name = "user"）和密码（password = uuid）

![image-20231205164049257](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202402241522474.png)
