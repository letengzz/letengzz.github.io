...
4. 要操作数据库，最简单直接的方法就是使用JdbcTemplate来完成：它给我们封装了很多方法使用，比如要查询数据库中的一条记录
   ...
   ![image-20230716000431492](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202411211523418.png)
   ...
   ![image-20230720215124918](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202411211524390.png)
...
![image-20230720224314223](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202411211526701.png)
