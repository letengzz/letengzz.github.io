...
![image-20230722222430548](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307222226770.png)

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307222256042.png)
...
- 官方提供简化开发的场景启动器：命名为：`spring-boot-starter-*`
  ...
  ![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202411172030764.png)

- 第三方提供简化开发的场景启动器：命名为：`*-spring-boot-starter`

  ![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202411172030855.png)
...
![image-20230723202609497](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307232027310.png)

## 自动配好SpringMVC

SpringBoot能够自动引入SpringMVC全套组件并配置好SpringMVC的常用组件，如：字符编码问题

![image-20230723203327808](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307232033251.png)
...
![image-20230727230833628](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307272308589.png)

![image-20230727231152519](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307272311007.png)
...
![image-20230727223448337](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307272235441.png)
...
![image-20230728000227586](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/Two-C/img/Java/202307280002773.png)
