...
![image-20240309184632287](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202403091846901.png)
...
![image-20240501154741763](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405011549237.png)

默认`protected-mode yes` 改为 `protected-mode no`：关闭保护模式

![image-20240501155013907](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405011550462.png)

添加redis密码 改为 requirepass 你自己设置的密码

![image-20240501155143447](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405011551891.png)
