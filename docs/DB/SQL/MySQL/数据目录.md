...
- 相关命令目录：/usr/bin（mysqladmin、mysqlbinlog、mysqldump等命令）和/usr/sbin
  ...
  ![image-20240723202116825](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202412011808774.png)

- 配置文件目录：/usr/share/mysql-8.0 (命令及配置文件)，/etc/mysql (如my.cnf)

  ![image-20240723202411464](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202412011808373.png)

  ![image-20240723202449390](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202412011808670.png)
...
![image-20240723203317130](https://cdn.jsdelivr.net/gh/letengzz/tc2/img202412011808101.png)
