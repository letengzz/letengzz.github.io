...
- 相关命令目录：/usr/bin（mysqladmin、mysqlbinlog、mysqldump等命令）和/usr/sbin
  ...
  ![image-20240723202116825](assets/image-20240723202116825.png)

- 配置文件目录：/usr/share/mysql-8.0 (命令及配置文件)，/etc/mysql (如my.cnf)

  ![image-20240723202411464](assets/image-20240723202411464.png)

  ![image-20240723202449390](assets/image-20240723202449390.png)
...
![image-20240723203317130](assets/image-20240723203317130.png)
