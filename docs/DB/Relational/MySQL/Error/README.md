...
![image-20211127170411358](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042039940.png)
...
![image-20211127170434387](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042039474.png)

### 丢失MSVCP140.dll

![image-20211127170442613](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042039471.png)
...
![image-20220222180637898](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042040020.png)

### mysql服务启动失败

MySQL error 1042: Unable to connect to any of the specified MySQL hosts.

![image-20220222181221100](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042041558.png)

![image-20220222181414534](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042041851.png)
...
![image-20220222182053069](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042041883.png)

如果是家庭版操作系统：

计算机（点击鼠标右键）》管理（点击）》服务和应用程序（点击）》服务（点击）》MySQL80（点击鼠标右键）》属性》登录选项卡下将选择的此账户改为选择本地系统账户。之后重新执行excute

![image-20220222182341155](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042041306.png)

![image-20220222182425252](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042041271.png)

### 可视化工具连接MySQL8问题

有些图形界面工具，特别是旧版本的图形界面工具，在连接MySQL8时出现“Authentication plugin 'caching_sha2_password' cannot be loaded”错误。

![image-20211127170917407](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042042803.png)
...
2. 第二种是把MySQL8用户登录密码加密规则还原成mysql_native_password。
   ...
   ![image-20211127171046998](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042044836.png)
...
2. 新建一个文本文件，文本文件中就写一条修改密码的语句
   ...
   ![image-20211128193420899](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042045746.png)
...
3. 使用管理员权限运行cmd命令行，运行以下命令：
   ...
   **注意**：my.ini文件的路径看你自己的安装路径，找数据目录
   ...
   ![image-20211128193734236](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042046265.png)

   上面命令意思就是初始化启动一次数据库，并运行这个修改密码的文件：

   ![image-20211128193623962](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042046029.png)

   上面的命令执行后，就像卡住了一样，这就是启动MySQL服务了。

4. 然后按CTRL+C结束上面的运行命令

   ![image-20211129084057307](https://fastly.jsdelivr.net/gh/LetengZzz/img@main/tc2/img/202407042047061.png)
