...
- 下载tomcat10：
  ...
  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222231415.png)

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222233735.png)

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222234130.png)

- 使用FTP工具将以上压缩包上传到CentOS：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222236333.png)

- 解压到当前目录下：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222237475.png)

- 第三方软件一般存放在/usr/local目录下，使用mv命令tomcat移动到该目录下：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222244202.png)

- 为了方便配置环境变量，将目录名重命名：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222245523.png)

  现在Tomcat服务器的根路径是：/usr/local/tomcat10

- 配置环境变量：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222245693.png)

- 让环境变量生效：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222246989.png)

- 启动Tomcat：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222246493.png)

- 查看服务器IP地址：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222246943.png)

- 关闭防火墙：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222246383.png)

- 打开windows上的浏览器，输入地址访问：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222246511.png)

- 关闭tomcat服务器：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222247531.png)
...
- 添加MySQL Yum存储库：将MySQL Yum存储库添加到系统中
  ...
  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222303258.png)

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222303907.png)

  鼠标右键单击：

  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222303346.png)
...
- 查看MySQL8字符集：在MySQL命令行界面中输入 `show variables like '%character%';` 可以查看MySQL的字符集设置
  ...
  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405222306020.png)
