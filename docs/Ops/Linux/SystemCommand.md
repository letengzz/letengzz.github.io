...
![image-20240519171029373](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405191710706.png)

`sudo` 命令：表示使用超级管理员身份执行该命令，如果当前不是管理员，希望以管理员身份执行某个命令时，使用sudo，需要输入超级管理员的密码：

![image-20240519171727789](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405191717335.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405212149113.webp)
...
- 启动sleep进程，在后台暂停1天：5277是这个sleep进程的id。
  ...
  ![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405220913637.webp)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221341866.webp)

杀死进程：

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221341802.webp)

杀死所有的sleep进程：

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221341039.webp)

## 查看正在运行的系统进程信息：top

top 命令是用于查看正在运行的系统进程信息的命令。它会**实时**动态地显示系统资源的使用情况，如 CPU 占用率、内存使用情况、进程情况等。通常用于系统监控和性能调优。

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221342381.webp)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221343547.webp)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221343036.webp)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221343195.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221344882.webp)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221344652.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221345072.png)

将 ls -al的执行结果重定向到 ls.txt 文件中。

ls.txt文件内容如下：

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221345567.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221346888.png)

将 a.txt 文件中的内容输入给 sort命令：

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221346463.png)

`<<`：可以接收键盘的输入：

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221347577.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221351977.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221355203.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221355031.png)

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221355374.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221400580.png)

下载结果：

![image.png](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202405221400315.png)
