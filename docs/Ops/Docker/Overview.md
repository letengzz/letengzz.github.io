...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406071302358.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406062310340.png)

## Docker 架构

![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406062312498.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406062317947.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406062327486.png)
...
-  联合文件系统(UnionFS)：UnionFS 是一种分层、轻量级并且高性能为 Linux 操作系统设计的用于把多个文件系统『联合』到同一个挂载点的文件系统服务。它支持对文件系统的修改作为一次提交来一层层的叠加，同时可以将不同目录挂载到同一个虚拟文件系统下(unite several directories into a single virtual filesystem)。
  ...
  ![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406062336855.png)
  
  ![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406062337979.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202410212153144.png)
...
![image-20240615141451958](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406151414719.png)
