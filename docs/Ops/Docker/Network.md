...
2. 启动机器之后，查看容器ip，通过容器的ip 去ping宿主机ip，发现是通的。
   ...
   ![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152222328.png)

   ```shell
   ping 172.17.0.2
   ```

   ![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152222629.png)

每启动一个docker容器，docker就会给docker容器分配一个ip，安装docker之后，会产生一个叫docker0的网卡，这里使用的就是veth-pair技术。

使用ip addr命令，查看网卡：

![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152223442.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152233999.png)

![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152233576.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152235748.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152235730.png)
...
![](https://cdn.jsdelivr.net/gh/LetengZzz/img@main/tc2/img202406152236368.png)
